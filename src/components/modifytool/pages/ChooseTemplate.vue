  ...
  <div class="container">
    ...
    <div id="slideshow" class="dragslider">
      <section class="img-dragger img-dragger-large dragdealer">
        <div class="handle" style="width: 800%; transform: translate3d(0px, 0px, 0px);">
          <div class="slide current" data-content="content-1" style="width: 12.5%;">
            <div class="img-wrap"><img src="https://goo.gl/yJcEnS" alt="img1"></div>
            <h2>Headed South<span>photo by <a href="https://500px.com/jeffclow"> jeffclow</a></span></h2>
            <button class="content-switch">Read more</button>
          </div>
          <div class="slide" data-content="content-2" style="width: 12.5%;">
            <div class="img-wrap"><img src="https://goo.gl/XrA0Te" alt="img2"></div>
            <h2>Misty Morning <span>photo by<a href="https://500px.com/SuthonKarawa"> SuthonKara</a></span></h2>
            <button class="content-switch">Read more</button>
          </div>
          <div class="slide" data-content="content-3" style="width: 12.5%;">
            <div class="img-wrap"><img src="https://goo.gl/fZ3ybS" alt="img3"></div>
            <h2>Sheeps <span> photo by <a href="https://500px.com/zeyirYalman"> zeyirYalman </a></span></h2>
            <button class="content-switch">Read more</button>
          </div>
          <div class="slide" data-content="content-4" style="width: 12.5%;">
            <div class="img-wrap"><img src="https://goo.gl/K33BSA" alt="img4"></div>
            <h2>Lofoten, Norway <span>photo by <a href="https://500px.com/svenbroeckx"> svenbroeckx</a></span></h2>
            <button class="content-switch">Read more</button>
          </div>
          <div class="slide" data-content="content-5" style="width: 12.5%;">
            <div class="img-wrap"><img src="https://goo.gl/1imQqi" alt="img5"></div>
            <h2>Matterhorn Magic II <span>photo by <a href="https://500px.com/ChristianWeber1"> ChristianWeber1</a></span></h2>
            <button class="content-switch">Read more</button>
          </div>
          <div class="slide" data-content="content-6" style="width: 12.5%;">
            <div class="img-wrap"><img src="https://goo.gl/dj2epC" alt="img6"></div>
            <h2>Mountain Sunrise <span>photo by <a href="https://500px.com/Sweet_Shot"> Sweet_Shot</a></span></h2>
            <button class="content-switch">Read more</button>
          </div>
          <div class="slide" data-content="content-7" style="width: 12.5%;">
            <div class="img-wrap"><img src="https://goo.gl/D2z0GU" alt="img7"></div>
            <h2>Huanca Sancos <span>photo by <a href="https://500px.com/rosmelparian"> rosmelparian</a></span></h2>
            <button class="content-switch">Read more</button>
          </div>
          <div class="slide" data-content="content-8" style="width: 12.5%;">
            <div class="img-wrap"><img src="https://goo.gl/ROooXa" alt="img8"></div>
            <h2>Kemaliye <span>photo by <a href="https://500px.com/mustafanasif"> mustafanasif</a></span></h2>
            <button class="content-switch">Read more</button>
          </div>
        </div>
      </section>
      <section class="pages">
        <div class="content" data-content="content-1">
          ...
          <p class="related">You might also like <a href="#">Inspiration for Article Intro Effects</a></p>
        </div>
        ...
        <div class="content" data-content="content-3">
          <h2>Taking Sneezes <span>Nothing is out there—let's try again</span></h2>
...
.overlay {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(41, 51, 60, 0.93);
  z-index: 10000;
}
.no-js .overlay,
.overlay.hide {
...
.info span.info-drag {background-image: url('https://goo.gl/FFqo8k');}
.info span.info-keys {background-image: url('https://goo.gl/XbFDk3');}
...
@media screen and (max-width: 650px) {
  ...
  .info span.info-keys {display: none;}
  .info span.info-switch {display: none;}
}
...
html,body,.js .container,.js .dragslider,.js .img-dragger .handle {height: 100%;}
html.js,.js body {overflow: hidden;position: relative;}
.js .dragslider {
  position: absolute;
  top: 0;
  left: 0;
...
button.slider-switch.view-maxi {background-image: url('https://goo.gl/gx2Q0a');}
button.slider-switch:hover {opacity: 1;}
...
button.content-switch:hover {opacity: 1;}
...
.show-content .current button.content-switch::before {content: "\f102";}
...
.no-js .pages .content h2 {padding-top: 1em;}
.pages .content h2 span {color: #95a5a6;}
.pages .content p {
  max-width: 1100px;
  margin: 0 auto;
  padding: 0.5em 2em;
...
.pages .content a:hover {color: #545b61;}
...
@media screen and (max-width: 63.125em) {
  ...
  .pages .content h2 {font-size: 3em;}
}
