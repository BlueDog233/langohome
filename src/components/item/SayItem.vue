...
<template>
  <div class="card glass-effect">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 330 307" height="2rem" width="2rem">
    ...
    <div class="body-text">
      HelloWorldssssssssssssssssssssssssssssss
    </div>
    <div class="author">--MybestFriend</div>
  </div>
</template>
...
.card:hover svg{
  transform: translateX(-4rem) rotateX(20deg);
}
